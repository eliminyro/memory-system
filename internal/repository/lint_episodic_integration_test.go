...
func TestCheckStale_ExcludesEpisodic(t *testing.T) {
	...
	findings, err := lr.CheckStale(context.Background(), tenantID, th, []string{models.DocTypeJournal, models.DocTypeHandoff})
...
func TestFindNearDuplicatePairs_ExcludesEpisodic(t *testing.T) {
	...
	lr := repository.NewLintRepository(db)
	pairs, err := lr.FindNearDuplicatePairs(context.Background(), tenantID, models.ScanThreshold, []string{models.DocTypeJournal, models.DocTypeHandoff})
	require.NoError(t, err)
...
func TestCheckNearDuplicates_ExcludesEpisodic(t *testing.T) {
	...
	findings, err := lr.CheckNearDuplicates(context.Background(), tenantID, th, []string{models.DocTypeJournal, models.DocTypeHandoff})
	require.NoError(t, err)

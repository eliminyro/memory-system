...
const (
	...
	OverrideTypeCrossTenantRead = "cross_tenant_read"
	OverrideTypePolicyChange    = "policy_change"
	OverrideTypeVerification    = "verification"
)
...
const (
	...
	OverrideToolReadScope              = "read_scope"
	OverrideToolSetDocTypePolicy       = "set_doc_type_policy"
	OverrideToolMarkVerified           = "mark_verified"
)

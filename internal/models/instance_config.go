...
// InstanceConfigNotifyChannel is the LISTEN/NOTIFY channel the instance_config
// trigger signals on write; the config-invalidation listener registers a reload
// against it. Fixed identifier — safe to interpolate into the trigger DDL.
